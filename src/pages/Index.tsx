...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              Infrastructure
              <span className="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent"> That Actually Works</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                to="/learn-more" 
                className="border-2 border-slate-300 dark:border-slate-600 hover:border-cyan-500 bg-white dark:bg-transparent text-slate-900 dark:text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors hover:bg-slate-50 dark:hover:bg-slate-800"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-700 dark:text-slate-300">Infrastructure that grows with your business, not against it.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-700 dark:text-slate-300">Protect your data and operations with proven security practices.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-700 dark:text-slate-300">Buy the right gear for your actual needs, not vendor recommendations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Services Section */}
      <section id="services" className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-100 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          {/* Cross-sell strategy */}
          <div className="mt-16 bg-white dark:bg-slate-800/30 border-2 border-slate-200 dark:border-slate-700 rounded-xl p-8">
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 text-center">The Infrastructure Flywheel</h3>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-slate-700 dark:text-slate-300">
              <div className="text-center">
                <div className="bg-cyan-100 dark:bg-cyan-600/20 p-4 rounded-lg mb-2">
                  <Search className="text-cyan-600 dark:text-cyan-400 mx-auto" size={24} />
                </div>
                <span className="font-semibold">Audit</span>
                <p className="text-sm">Exposes gaps</p>
              </div>
              <ArrowRight className="text-cyan-600 dark:text-cyan-400 hidden md:block" size={20} />
              <div className="text-center">
                <div className="bg-cyan-100 dark:bg-cyan-600/20 p-4 rounded-lg mb-2">
                  <Settings className="text-cyan-600 dark:text-cyan-400 mx-auto" size={24} />
                </div>
              ...
              <div className="text-center">
                <div className="bg-cyan-100 dark:bg-cyan-600/20 p-4 rounded-lg mb-2">
                  <Target className="text-cyan-600 dark:text-cyan-400 mx-auto" size={24} />
                </div>
      ...
      {/* Not Sure Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-100 to-cyan-100 dark:from-green-900/20 dark:to-cyan-900/20">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-100 to-blue-100 dark:from-cyan-900/20 dark:to-blue-900/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              to="/learn-more" 
              className="border-2 border-cyan-500 text-cyan-600 hover:bg-cyan-600 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
            >
